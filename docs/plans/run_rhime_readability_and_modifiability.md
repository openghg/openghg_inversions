...
### W3a — expose the visible orchestration spine
...
### W2.0 — publish the complete copy-and-modify runner
...
### W2a — add the preferred Python likelihood seam
...
Each PR must retain a runnable, reviewed `run_rhime` path. Avoid one large
rewrite.
