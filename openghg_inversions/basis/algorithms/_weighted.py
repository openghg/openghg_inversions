...
def load_landsea_indices() -> np.array:
    """
...
def bucket_value_split(grid : np.array, 
                       bucket : float, 
...
def bucket_split_landsea_basis(grid : np.array, 
                               bucket : float) -> np.array:
    """
...
def nregion_landsea_basis(grid : np.array,
                          bucket : float = 1,
                          nregion : int = 100, 
                          tol : int = 1) -> np.array:
    """
