...
if __name__ == "__main__":
    ...
    ds_list, filenames = process.extract_hbmcmc_files(
        output_directory, species, domain, runname, dates, return_filenames=True
    )
    ...
    if plot_y_timeseries == True:
        ...
        if combine_timeseries and len(ds_list) > 1:
            ...
            process.plot_timeseries(ds_combined, fig_text=None, ylim=None, out_filename=y_out_filename)
        else:
