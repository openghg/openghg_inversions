...
class FixedOuLowRank:
    ...
    def evaluate(
        ...
        An invalid amplitude or residual returns negative infinity with a safe
        rejection gradient. Non-positive generalized base-plus-OU mode
        variances are rejected before applying the low-rank update.
...
def add_fixed_ou_gaussian_likelihood(
    *,
    ...
    if fixed_site_amplitudes is None:
        ...
        mode_variance = prepared.mode_eigenvalues + np.square(values)[prepared.mode_site_index]
