...
def mhd_with_inner_domain_ch4_data_args():
    ...
    data_args = {
        ...
        "emissions_store": "/group/chem/acrg/prasad/job_scripts/openghg_inversions/prior_flux_2023_EUROPE",
        "inner_footprint_store": "/group/chem/acrg/object_stores/shared_store_zarr",
        "inner_emissions_store": "/group/chem/acrg/prasad/job_scripts/openghg_inversions/prior_flux_2023_EUROPE_6km",
        "inlet": ["9m"],
        "instrument": None,
        "domain": "EUROPE", 
        "inner_domain": "6km",
        ...
        "fp_species": "inert",
        "fp_model": "NAME",
        "emissions_name": ["edgar_wetcharts"],
        "averaging_period": ["4h"],
