...
- Added an exact labelled coherent Gaussian reduction that constructs and
  ...
  observation covariance. The eager backend-neutral boundary uses Cholesky
  solves rather than explicit inverses, preserves gathered state and
  observation labels, and validates the linked covariance identities together.
