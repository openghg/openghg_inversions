...
- Routed modern RHIME flux, country, and PARIS flux postprocessing through retained `BasisFunctions` / `BasisOperator` products where available, while keeping fixedbasis `LegacyInversionOutput` on the existing flat-basis fallback. [#383](https://github.com/openghg/openghg_inversions/issues/383)
