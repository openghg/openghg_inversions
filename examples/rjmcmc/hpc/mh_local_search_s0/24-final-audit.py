#!/usr/bin/env python3
"""Freeze, verify, and independently finalize an immutable S0 harness run."""
...
def _source_inventory(source: Path) -> tuple[list[str], dict[str, str], str]:
    ...
    if (
        ...
        or inventory["schema"] != "openghg_inversions.mh_local_search_s0_harness_inventory.v1"
...
def _verify_harness(
    ...
    *,
    ...
    if (
        ...
        or completion["schema"] != "openghg_inversions.mh_local_search_s0_frozen_harness.v1"
...
def command_freeze(arguments: argparse.Namespace) -> None:
    ...
    _create_json(
        ...
        {
            "schema": "openghg_inversions.mh_local_search_s0_frozen_harness.v1",
...
def command_finalize(arguments: argparse.Namespace) -> None:
    ...
    payload = {
        "schema": "openghg_inversions.mh_local_search_s0_final_completion.v1",
        "profile": profile,
