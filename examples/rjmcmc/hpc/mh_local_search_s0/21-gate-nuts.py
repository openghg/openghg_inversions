...
def run(arguments: argparse.Namespace) -> dict[str, object]:
    ...
    for task, _, topology, cell_task, key in references:
        ...
        evaluation_path = arguments.run_root / "03-materialize" / "sealed-evaluation" / f"{cell_key}.json"
    ...
    payload: dict[str, object] = {
        "schema": "openghg_inversions.mh_local_search_s0_nuts_gate.v1",
    ...
    if retries:
        ...
        selection = {
            "schema": "openghg_inversions.mh_local_search_s0_nuts_selection.v1",
            "selected": selected,
