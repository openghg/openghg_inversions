#!/usr/bin/env python3
"""Build the strict 12-cell/5-reference S0 aggregate index."""
...
def run(arguments: argparse.Namespace) -> Path:
    ...
    definition = arguments.run_root / "03-materialize/definition.json"
    cells: list[dict[str, object]] = []
    for scenario, replicate, cell_key in cell_rows:
        training = arguments.run_root / "03-materialize/training" / f"{cell_key}.json"
        evaluation = arguments.run_root / "03-materialize/sealed-evaluation" / f"{cell_key}.json"
